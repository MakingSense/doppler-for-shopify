...
import { Layout, Card, Stack, ButtonGroup, Button, Icon } from '@shopify/polaris';
        ...
        <Layout.Section>
          <Card title="Synchronization confirmation" sectioned>
            <Stack spacing="extraTight">
              ...
              <p>By running the synchronization process the existing subscribers</p>
            </Stack>
            <p>will be replaced by the Shopify customers data. Do you want to continue?</p><br/>
            <Stack alignment="center" distribution="trailing">
              <ButtonGroup>
                <Button onClick={this.handleYesButtonClick} primary>Yes</Button>
