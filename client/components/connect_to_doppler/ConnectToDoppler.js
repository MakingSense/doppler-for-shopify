...
class ConnectToDoppler extends Component {
  ...
  validateCurrentState() {
    return this.state.dopplerAccountName && this.state.dopplerAccountName !== ''
        && this.state.dopplerApiKey && this.state.dopplerApiKey !== ''
  }
...
function mapStatesToProps(state, ownProps) {
    return {
      ...
      invalidDopplerCredentials: state.reducers.connectingToDoppler.invalidDopplerCredentials,
