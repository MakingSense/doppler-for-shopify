...
export const setupDopplerList = (state = initialState.setupDopplerList, action) => {
  switch (action.type) {
    ...
    return {
        ...
        selectedListId: state.selectedListId == null && action.dopplerLists.length > 0 
          ? action.dopplerLists[0].value : state.selectedListId
      };
